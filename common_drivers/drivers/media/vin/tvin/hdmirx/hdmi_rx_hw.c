...
void rx_edid_module_reset(void)
{
	...
	hdmirx_wr_bits_top_common(TOP_EDID_GEN_CNTL, MSK(3, 8), 0);
}
...
void cor_init(u8 port)
{
	...
	hdmirx_wr_cor(RX_AON_SRST_AON_IVCRX, data8, port);//register address: 0x0005
