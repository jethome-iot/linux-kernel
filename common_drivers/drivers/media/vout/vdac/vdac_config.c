...
static struct meson_vdac_ctrl_s vdac_ctrl_enable_t6d[] = {
	{ANACTRL_VDAC_CTRL1, 1, 7, 1}, /* cdac_en */
	{ANACTRL_VDAC_CTRL1, 1, 18, 1}, /* cdac_data_reg_en */
	{ANACTRL_VDAC_CTRL1, 0x230, 8, 10}, /* cdac_data_reg */
	{VDAC_REG_MAX, 0, 0, 0},
};
...
static struct meson_vdac_data meson_t6d_vdac_data = {
	.cpu_id = VDAC_CPU_T6D,
	.name = "meson-t6d-vdac",
	...
	.reg_vid_clk_ctrl2 = CLKCTRL_VID_CLK_CTRL2,
	.reg_vid2_clk_div = CLKCTRL_VIID_CLK_DIV,
	.ctrl_table = vdac_ctrl_enable_t6d,
	.cdac_disable = 1,
