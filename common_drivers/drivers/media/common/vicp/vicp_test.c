...
int vicp_test(void)
{
	...
	data_config.input_data.data_dma.buf_addr = mif_in_addr;
	data_config.input_data.data_dma.buf_stride_w = input_width;
	data_config.input_data.data_dma.buf_stride_h = input_height;
	data_config.input_data.data_dma.color_format = VICP_COLOR_FORMAT_YUV420;
	data_config.input_data.data_dma.color_depth = 8;
	data_config.input_data.data_dma.data_width = input_width;
	data_config.input_data.data_dma.data_height = input_height;
	data_config.input_data.data_dma.plane_count = 2;
	data_config.input_data.data_dma.endian = 0;
	data_config.input_data.data_dma.need_swap_cbcr = 0;
	...
	memset(&data_config, 0, sizeof(struct vicp_data_config_s));
	data_config.input_data.is_vframe = false;
	data_config.input_data.data_dma.buf_addr = mif_out_addr;
	data_config.input_data.data_dma.buf_stride_w = input_width;
	data_config.input_data.data_dma.buf_stride_h = input_height;
	data_config.input_data.data_dma.color_format = VICP_COLOR_FORMAT_YUV420;
	data_config.input_data.data_dma.color_depth = 8;
