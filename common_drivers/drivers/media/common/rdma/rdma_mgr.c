...
static ssize_t show_video_all_reg(struct class *class,
				struct class_attribute *attr,
				char *buf)
{
	int i;
...
static ssize_t rdma_mgr_trace_enable_store(struct class *cla,
					   struct class_attribute *attr,
					   const char *buf, size_t count)
{
	int ret = 0;
...
static ssize_t rdma_mgr_trace_reg_store(struct class *cla,
					struct class_attribute *attr,
					const char *buf, size_t count)
{
...
static ssize_t rdma_partition_enable_show(struct class *cla,
				       struct class_attribute *attr, char *buf)
{
	ssize_t ret = 0;
	int i, j;
...
static ssize_t rdma_partition_enable_store(struct class *cla,
					struct class_attribute *attr,
					const char *buf, size_t count)
{
	int parsed[3];
