...
static struct meson_msr_id clk_msr_s6[] __initdata = {
	...
	CLK_MSR_ID(99, "cts_hevcf_clk"),
	CLK_MSR_ID(106, "deskew_pll_clk_div32_out"),
	CLK_MSR_ID(108, "cts_cmpr_clk"),
	CLK_MSR_ID(109, "cts_dewarpa_clk"),
	CLK_MSR_ID(110, "cts_sc_clk"),
	CLK_MSR_ID(111, "cts_aux_adc_clk"),
	CLK_MSR_ID(113, "cts_sd_emmc_c_clk"),
	CLK_MSR_ID(114, "cts_sd_emmc_b_clk"),
	...
	CLK_MSR_ID(195, "am_ring_osc_clk_out[15]"),
	CLK_MSR_ID(196, "am_ring_osc_clk_out[16]"),
	CLK_MSR_ID(197, "cts_nna_core_clk"),
	CLK_MSR_ID(198, "cts_vc9000e_aclk"),
	CLK_MSR_ID(199, "cts_vc9000e_core_clk"),
	CLK_MSR_ID(201, "cts_pcie_tl_clk"),
...
static struct meson_msr_id clk_msr_t6d[] __initdata = {
	CLK_MSR_ID(0, "cts_sys_clk"),
	CLK_MSR_ID(1, "cts_axi_clk"),
	CLK_MSR_ID(2, "cts_rtc_clk"),
	CLK_MSR_ID(3, "vencl_clk"),
	CLK_MSR_ID(4, "cts_mali_clk"),
	CLK_MSR_ID(5, "mali_aclkm_tm"),
	CLK_MSR_ID(6, "sys_cpu_clk_div16"),
	CLK_MSR_ID(8, "cts_cecb_clk"),
	CLK_MSR_ID(10, "fclk_div5"),
	CLK_MSR_ID(11, "hdmi_vx1_p2s_clk"),
	CLK_MSR_ID(12, "hdmi_vx1_clk"),
	CLK_MSR_ID(15, "mpll_clk_50m"),
	CLK_MSR_ID(18, "hifi1_pll_clk"),
	CLK_MSR_ID(19, "hifi_pll_clk"),
	CLK_MSR_ID(20, "gp0_pll_clk"),
	...
	CLK_MSR_ID(120, "hrx_axi_clk"),
	CLK_MSR_ID(121, "cts_ts_clk(temp sensor)"),
	CLK_MSR_ID(122, "cts_usb2_48m_clk"),
	CLK_MSR_ID(125, "adc_dpll_intclk"),
	CLK_MSR_ID(126, "adc_extclk_in"),
	CLK_MSR_ID(127, "cts_demod_32k_clk"),
	CLK_MSR_ID(128, "cts_demod_core_t2_clk"),
	CLK_MSR_ID(129, "cts_demod_core_clk"),
	CLK_MSR_ID(130, "AU_ADC_CLK_G128X"),
	CLK_MSR_ID(131, "AU_DAC1_CLK_G128X"),
	CLK_MSR_ID(141, "toacodec_bclk"),
	CLK_MSR_ID(142, "toacodec_mclk"),
	CLK_MSR_ID(143, "audio_spdifoutb_mst_clk"),
	CLK_MSR_ID(144, "audio_spdifout_mst_clk"),
	CLK_MSR_ID(145, "audio_spdifin_mst_clk"),
	CLK_MSR_ID(146, "audio_mclk"),
	CLK_MSR_ID(147, "vad_clk"),
	CLK_MSR_ID(148, "tdmout_d_sclk"),
	CLK_MSR_ID(149, "tdmout_c_sclk"),
	CLK_MSR_ID(150, "atv_dmd_mono_clk_32"),
	CLK_MSR_ID(151, "atv_dmd_i2s_sclk"),
	CLK_MSR_ID(152, "adec_i2s_sclk"),
	CLK_MSR_ID(153, "acodec_i2sout_bclk"),
	CLK_MSR_ID(154, "au_adc_clk_to_gpio"),
	CLK_MSR_ID(155, "au_dac1_clk_to_gpio"),
	CLK_MSR_ID(156, "cts_pwm_h_clk"),
	CLK_MSR_ID(157, "cts_pwm_g_clk"),
	CLK_MSR_ID(160, "p20_usb2_ckout"),
	CLK_MSR_ID(162, "p22_usb2_ckout"),
	CLK_MSR_ID(163, "p21_usb2_ckout"),
	CLK_MSR_ID(164, "cts_pwm_f_clk"),
	CLK_MSR_ID(165, "cts_pwm_e_clk"),
	...
	CLK_MSR_ID(169, "cts_pwm_a_clk"),
	CLK_MSR_ID(170, "cts_ACLKM"),
	CLK_MSR_ID(171, "ddrphy_dficlk"),
	CLK_MSR_ID(172, "ddrphy_pclk"),
	CLK_MSR_ID(173, "ts_vpu_clk"),
	CLK_MSR_ID(174, "dmc_difclk"),
	CLK_MSR_ID(175, "ts_cpu_clk"),
	CLK_MSR_ID(176, "rng_ring_0"),
	CLK_MSR_ID(177, "rng_ring_1"),
	CLK_MSR_ID(178, "rng_ring_2"),
	...
	CLK_MSR_ID(235, "tdmin_b_sclk"),
	CLK_MSR_ID(236, "tdmin_a_sclk"),
	CLK_MSR_ID(237, "resampleb_clk"),
	CLK_MSR_ID(238, "resamplea_clk"),
	CLK_MSR_ID(239, "pdmb_sysclk"),
	CLK_MSR_ID(240, "pdmb_dclk"),
	CLK_MSR_ID(241, "pdm_sysclk"),
	CLK_MSR_ID(242, "pdm_dclk"),
	CLK_MSR_ID(243, "alockerb_out_clk"),
	CLK_MSR_ID(244, "alockerb_in_clk"),
	CLK_MSR_ID(245, "alocker_out_clk"),
	CLK_MSR_ID(246, "alocker_in_clk"),
	CLK_MSR_ID(247, "resamplec_clk"),
};
#endif
#endif
...
static struct meson_msr_data meson_t6d_data __initdata = {
	.msr_table = (struct meson_msr_id *)&clk_msr_t6d,
	.table_size = ARRAY_SIZE(clk_msr_t6d),
	.duty_offset = (0x6 * 4),
	.reg0_offset = 0x0,
	.reg1_offset = 0x4,
	.reg2_offset = 0x8,
