...
static int init_inode_xattrs(struct inode *inode)
{
	...
	if (wait_on_bit_lock_t(&vi->flags, EROFS_I_BL_XATTR_BIT, TASK_KILLABLE))
		return -ERESTARTSYS;
...
struct posix_acl *erofs_get_acl(struct inode *inode, int type, bool rcu)
{
	...
	int prefix, rc;
	char *value = NULL;
	posix_acl_from_xattr_tt f = NULL;

	f = (posix_acl_from_xattr_tt)posix_acl_from_xattr_t;
