...
#define LCD_PRIORITY_MDSW_POWER_OFF      LCD_PRIORITY_POWER_IF_OFF
#define LCD_PRIORITY_MDSW_POWER_ON       LCD_PRIORITY_POWER_IF_ON
#define LCD_PRIORITY_MDSW_DATA_OFF       LCD_PRIORITY_POWER_IF_OFF
#define LCD_PRIORITY_MDSW_DATA_ON        LCD_PRIORITY_POWER_IF_ON
...
#define LCD_EVENT_MDSW_POWER_ON        BIT(8)
#define LCD_EVENT_MDSW_POWER_OFF       BIT(9)
#define LCD_EVENT_MDSW_DATA_ON         BIT(10)
#define LCD_EVENT_MDSW_DATA_OFF        BIT(11)

/* combined event */
#define LCD_EVENT_MDSW_LIMIT_ON          \
	(LCD_EVENT_MDSW_POWER_ON)
#define LCD_EVENT_MDSW_LIMIT_OFF         \
	(LCD_EVENT_MDSW_POWER_OFF)
#define LCD_EVENT_MDSW_MIN_ON          \
	(LCD_EVENT_MDSW_DATA_ON)
#define LCD_EVENT_MDSW_MIN_OFF         \
	(LCD_EVENT_MDSW_DATA_OFF)

#define LCD_EVENT_PREPARE        (LCD_EVENT_ENCL_ON)
#define LCD_EVENT_UNPREPARE      (LCD_EVENT_ENCL_OFF)
#define LCD_EVENT_POWER_ON       (LCD_EVENT_IF_ON)
#define LCD_EVENT_POWER_OFF      (LCD_EVENT_IF_OFF)
#define LCD_EVENT_ENABLE         (LCD_EVENT_PREPARE | LCD_EVENT_POWER_ON)
#define LCD_EVENT_DISABLE        (LCD_EVENT_POWER_OFF | LCD_EVENT_UNPREPARE)
