...
#define T7_REE2AO6       (T7_AO2REE + 7)
#define T7_DSPB2REE0     (T7_REE2AO6 + 1)
#define T7_REE2DSPB0     (T7_REE2AO6 + 2)
#define T7_REE2DSPB1     (T7_REE2AO6 + 3)
#define T7_REE2DSPB2     (T7_REE2AO6 + 4)
...
#define T7_REE2AO_IR     T7_REE2AO6
