...
#undef TRACE_SYSTEM
#define TRACE_SYSTEM aerofs

#if !defined(_TRACE_AEROFS_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_AEROFS_H
...
DEFINE_EVENT(erofs__map_blocks_enter, aerofs_map_blocks_flatmode_enter,
	TP_PROTO(struct inode *inode, struct erofs_map_blocks *map,
		 unsigned flags),
...
DEFINE_EVENT(erofs__map_blocks_enter, az_erofs_map_blocks_iter_enter,
	TP_PROTO(struct inode *inode, struct erofs_map_blocks *map,
		 unsigned int flags),
...
DEFINE_EVENT(erofs__map_blocks_exit, aerofs_map_blocks_flatmode_exit,
	TP_PROTO(struct inode *inode, struct erofs_map_blocks *map,
...
DEFINE_EVENT(erofs__map_blocks_exit, az_erofs_map_blocks_iter_exit,
	TP_PROTO(struct inode *inode, struct erofs_map_blocks *map,
		 unsigned int flags, int ret),
...
TRACE_EVENT(aerofs_destroy_inode,
